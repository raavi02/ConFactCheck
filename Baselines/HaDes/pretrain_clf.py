# The code for HaDes baseline, as obtained from the official repository https://github.com/microsoft/HaDes.
# Data formatting on the original LLM-generated output files is the same provided in the repository, the python notebook for getting the formatted file is provided here too.
# Commands to run the code are present in the HaDes repository itself.
          ...
          if os.path.exists(model_path):
              ...
              for step, batch in tqdm(enumerate(test_dataloader)):
                ...
                #   print(batch)
                  ...
                  predy.extend(pred.tolist())
                  hallu_sm_score.extend(hallu_sm.tolist())
                  print(testy, predy, hallu_sm_score)
                #   with open('/home/ganesh/pranav/nqopen_hades_res.pkl', 'wb') as file:
                #       pickle.dump(predy, file)
                  with open('/home/pranav/pranav/hades_files/qwen_webq_hades.pkl', 'wb') as file:
                      pickle.dump(hallu_sm_score, file)
              print("Test ...")
